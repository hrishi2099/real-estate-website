  ...
  const renderOverviewCards = () => {
    ...
    return (
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
        <div className="bg-white p-3 sm:p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center">
            ...
            <div className="flex-1">
              <p className="text-xs sm:text-sm font-medium text-gray-600">Total Deals</p>
              <p className="text-lg sm:text-2xl font-semibold text-gray-900">{totalDeals}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-3 sm:p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm sm:text-2xl font-semibold text-gray-900 truncate">
        ...
        <div className="bg-white p-3 sm:p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center">
            <div className="p-2 bg-orange-100 rounded-lg mb-2 sm:mb-0 sm:mr-4">
              <svg className="w-4 h-4 sm:w-6 sm:h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <div className="flex-1">
              <p className="text-xs sm:text-sm font-medium text-gray-600">Avg Cycle Time</p>
  ...
  const renderStageDistribution = () => {
    ...
    return (
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-200">
        <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-3 sm:mb-4">Stage Distribution</h3>
        <div className="space-y-3 sm:space-y-4">
          {stageEntries.map(([stage, data]) => (
            <div key={stage} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              ...
              <div className="flex items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-500 ml-2 sm:ml-0">
                <span>{data.avgProbability}% avg</span>
                <span className="hidden sm:inline">{formatCurrency(data.avgValue)} avg</span>
                <span className="sm:hidden">₹{(data.avgValue / 100000).toFixed(1)}L avg</span>
  ...
  const renderKanbanView = () => {
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
        <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-4 sm:mb-6">Pipeline Kanban</h3>
        ...
        {/* Desktop: Kanban View */}
        <div className="hidden lg:grid lg:grid-cols-4 gap-6 overflow-x-auto">
          {allStages.map(stage => (
    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm sm:text-base text-gray-600">Track deals through your sales process</p>
        </div>
        <div className="flex items-center">
          <div className="flex bg-gray-100 rounded-lg p-1 w-full sm:w-auto">
            <button
              onClick={() => setViewMode('overview')}
              className={`flex-1 sm:flex-none px-3 py-2 text-xs sm:text-sm font-medium rounded-md transition-colors touch-manipulation ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          ...
          <div className="flex items-end sm:col-span-2 lg:col-span-1">
            <button
              ...
              className="w-full px-3 py-2.5 text-sm text-gray-600 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200 touch-manipulation"
            >
              Clear Filters
            </button>
          </div>
