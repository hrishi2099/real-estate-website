  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          <div className="text-2xl font-bold text-purple-600">{gradeStats.qualified}</div>
          <div className="text-sm text-gray-600">Qualified</div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          <div className="text-2xl font-bold text-red-600">{gradeStats.hot}</div>
          <div className="text-sm text-gray-600">Hot</div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          <div className="text-2xl font-bold text-orange-600">{gradeStats.warm}</div>
          <div className="text-sm text-gray-600">Warm</div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          <div className="text-2xl font-bold text-blue-600">{gradeStats.cold}</div>
            ...
            <div className="mt-3">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className={`text-xl font-bold ${getScoreColor(scoreBreakdown.score)}`}>
                    {scoreBreakdown.score}
                  </span>
                </div>
                
                <div className="flex items-center justify-center">
                  <span className={`inline-flex px-4 py-2 text-sm font-semibold rounded-full ${getGradeColor(scoreBreakdown.grade)}`}>
                ...
                <div className="space-y-2">
                  ...
                  {Object.entries(scoreBreakdown.breakdown).map(([key, value]) => (
                    <div key={key} className="flex justify-between py-1">
                      ...
                      <span className="text-sm font-medium">{Math.round(value as number)} pts</span>
                    </div>
                  ))}
                </div>
              </div>
