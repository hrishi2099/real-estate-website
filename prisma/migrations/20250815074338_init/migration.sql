...
CREATE TABLE `users` (
    ...
    `role` ENUM('USER', 'ADMIN', 'SALES_MANAGER') NOT NULL DEFAULT 'USER',
...
CREATE TABLE `properties` (
    ...
    `type` ENUM('APARTMENT', 'HOUSE', 'VILLA', 'CONDO', 'TOWNHOUSE', 'COMMERCIAL', 'LAND') NOT NULL,
...
-- AddForeignKey
ALTER TABLE `lead_assignments` ADD CONSTRAINT `lead_assignments_leadId_fkey` FOREIGN KEY (`leadId`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
